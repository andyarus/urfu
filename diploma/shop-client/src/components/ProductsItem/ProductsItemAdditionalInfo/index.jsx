...
function ProductsItemAdditionalInfo({ item, type }) {
    const getPageContentText = (type) => {
        if (type === "description") {
            return <div className="product-addition-info__text">{item.description}</div>;
        }
        if (type === "sizes") {
            return <div className="product-addition-info__text">Доступны любые размеры на заказ.</div>;
        }
        if (type === "brand") {
            return <div className="product-addition-info__text">Доступны товары любых брендов</div>;
        }
        if (type === "delivery") {
            return <div className="product-addition-info__text">Доставка в любую точку мира</div>;
        }
    };
    return (
        <div className="product-addition-info__content">
            {getPageContentText(type)}
...
export default ProductsItemAdditionalInfo;
