        ...
        <>
            <div className="admin-list">
                <div className="admin-list__menu">
                    ...
                    <div className="admin-list__add-item">Добавить товар</div>
                </div>
                <div className="admin-list__admin-list-item admin-list-item">
                    ...
                    <div className="admin-list-item__info">
                        <div className="admin-list-item__info_title">
                    ...
                    <div className="admin-list-item__price">
                        <div className="admin-list-item__price_now">8 590 руб</div>
                        <div className="admin-list-item__price_discount">
                            <div className="admin-list-item__price_without-discount">11 490 ₽</div>
                            <div className="admin-list-item__price_discount-persent">- 25%</div>
                        </div>
                    </div>
                    <div className="admin-list-item__delete">
